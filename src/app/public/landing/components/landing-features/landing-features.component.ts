...
export class LandingFeaturesComponent {
  readonly features: Feature[] = [
    ...
    { color: 'gold', acc: 'gold', title: 'Marketplace incluido', body: 'Tu negocio aparece en el directorio LETS RESERVE — clientes nuevos te descubren sin pagar publicidad. (Próximamente)' },
  ];
}
