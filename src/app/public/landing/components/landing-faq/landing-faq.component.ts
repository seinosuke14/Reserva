...
export class LandingFaqComponent {
  ...
  readonly faqItems: FaqItem[] = [
    ...
    { q: '¿Y si mis clientes no entienden cómo agendar?', a: 'Tu link es público y funciona desde cualquier celular. Tus clientes no se registran: eligen servicio, eligen hora y listo. Reciben confirmación por WhatsApp.' },
